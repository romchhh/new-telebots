...
import { WEBSITE_INTENT_BY_LANG } from './websiteIntent';
...
const BY_LANG: Record<Language, Record<SeoLandingSlug, SeoLandingCopy>> = {
  uk: { ...UK_SEO_LANDINGS, ...CHATBOT_INTENT_BY_LANG.uk, ...WEBSITE_INTENT_BY_LANG.uk },
  en: { ...EN_SEO_LANDINGS, ...CHATBOT_INTENT_BY_LANG.en, ...WEBSITE_INTENT_BY_LANG.en },
  pl: { ...PL_SEO_LANDINGS, ...CHATBOT_INTENT_BY_LANG.pl, ...WEBSITE_INTENT_BY_LANG.pl },
  ru: { ...RU_SEO_LANDINGS, ...CHATBOT_INTENT_BY_LANG.ru, ...WEBSITE_INTENT_BY_LANG.ru },
};
