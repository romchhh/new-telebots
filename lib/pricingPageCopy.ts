...
export const pricingPageCopy: Record<Language, PricingPageCopy> = {
  uk: {
    metaTitle: 'Ціни на розробку сайтів, чат-ботів та дизайну — орієнтири TeleBots',
    metaDescription:
      'Орієнтовні вилки цін на лендинги, корпоративні сайти, інтернет-магазини, Telegram-ботів та UI/UX. Що впливає на бюджет, терміни та етапи оплати. Безкоштовна консультація. Розробка під ключ у TeleBots — Київ, Україна, віддалено по світу.',
    metaKeywords:
    ...
    h1: 'Ціни та орієнтири вартості послуг TeleBots',
    subtitle:
