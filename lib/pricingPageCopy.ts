...
export const pricingPageCopy: Record<Language, PricingPageCopy> = {
  uk: {
    ...
    resourceLinks: [
      { label: 'Розробка сайту ціна', href: '/uk/solutions/website-development-price' },
      { label: 'Скільки коштує лендинг', href: '/uk/solutions/landing-page-price' },
      { label: 'Ціна інтернет-магазину', href: '/uk/solutions/online-store-price' },
      ...
      { label: 'Скільки коштує сайт (блог)', href: '/uk/blog/skilky-koshtuye-sayt' },
      { label: 'Розробка сайтів', href: '/uk/services/websites' },
    ],
  },
  en: {
    ...
    resourceLinks: [
      { label: 'Website development price', href: '/en/solutions/website-development-price' },
      { label: 'Landing page cost', href: '/en/solutions/landing-page-price' },
      { label: 'Online store price', href: '/en/solutions/online-store-price' },
      ...
      { label: 'Website services', href: '/en/services/websites' },
    ],
  },
  pl: {
    ...
    resourceLinks: [
      { label: 'Cena strony internetowej', href: '/pl/solutions/website-development-price' },
      { label: 'Koszt landing page', href: '/pl/solutions/landing-page-price' },
      { label: 'Cena sklepu online', href: '/pl/solutions/online-store-price' },
      ...
      { label: 'Strony internetowe', href: '/pl/services/websites' },
    ],
  },
  ru: {
    ...
    resourceLinks: [
      { label: 'Разработка сайта цена', href: '/ru/solutions/website-development-price' },
      { label: 'Сколько стоит лендинг', href: '/ru/solutions/landing-page-price' },
      { label: 'Цена интернет-магазина', href: '/ru/solutions/online-store-price' },
      ...
      { label: 'Разработка сайтов', href: '/ru/services/websites' },
    ],
  },
};
