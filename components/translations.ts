export const translations = {
  uk: {
    ...
    about: {
      ...
      founder: {
        ...
        imageAlt: 'Роман Федонюк, CEO · засновник TeleBots',
      },
      pageTitle: 'ПРО НАС',
    ...
    portfolio: {
      ...
      heroIntroDescription:
        'Telegram-боти, сайти та e-commerce з реальним результатом для бізнесу — задача, стек і ефект у кожному кейсі.',
      heroBackgroundAlt: 'Атмосферний фон сторінки кейсів TeleBots',
      ctaQuestion: 'Обговоримо ваш наступний проєкт?',
      ctaQuestionShort: 'Безкоштовна консультація',
      startDate: { label: 'проєктів', value: '200+' },
      duration: { label: 'на ринку', value: '4 роки' },
  ...
  en: {
    ...
    portfolio: {
      ...
      heroIntroDescription:
        'Telegram bots, websites, and e-commerce with real business outcomes — brief, stack, and results in every case.',
      heroBackgroundAlt: 'Atmospheric background for the TeleBots cases page',
      ctaQuestion: 'Shall we discuss your next project?',
      ctaQuestionShort: 'Free consultation',
      startDate: { label: 'projects', value: '200+' },
      duration: { label: 'in market', value: '4 years' },
    ...
    services: {
      ...
      pricingWebsites: {
        ...
        plans: [
          { name: 'LANDING', price: '150-300', description: 'One-page site for product or service presentation. Fast launch and maximum conversion.', features: ['Responsive design', 'Contact form', 'Speed optimization', 'Basic SEO', 'Google Analytics integration'], forWhom: 'Startups, local business, service promotion' },
          ...
          { name: 'E-COMMERCE', price: '400+', description: 'Full online store with payment system, product catalog and personal account.', features: ['Product catalog with filters', 'Cart and checkout', 'Payment system integration', 'Personal account', 'Discounts and promo codes', 'Admin panel'], forWhom: 'Online stores, e-commerce, retail' }
        ]
      },
      pricingParsers: {
  ...
  pl: {
    ...
    portfolio: {
      ...
      heroIntroDescription:
        'Boty Telegram, strony i e-commerce z realnym efektem biznesowym — brief, stack i wynik w każdym case.',
      heroBackgroundAlt: 'Atmosferyczne tło strony realizacji TeleBots',
      ctaQuestion: 'Omówimy Twój kolejny projekt?',
      ctaQuestionShort: 'Bezpłatna konsultacja',
      startDate: { label: 'projektów', value: '200+' },
      duration: { label: 'na rynku', value: '4 lata' },
    ...
    services: {
      ...
      pricingWebsites: {
        ...
        plans: [
          { name: 'LANDING', price: '150-300', description: 'Jednostronicowa strona do prezentacji produktu lub usługi. Szybki start i maksymalna konwersja.', features: ['Responsywny design', 'Formularz kontaktowy', 'Optymalizacja prędkości', 'Podstawowe SEO', 'Integracja z Google Analytics'], forWhom: 'Startupy, biznes lokalny, promocja usług' },
  ...
  ru: {
    ...
    portfolio: {
      ...
      heroIntroDescription:
        'Telegram-боты, сайты и e-commerce с реальным результатом для бизнеса — задача, стек и эффект в каждом кейсе.',
      heroBackgroundAlt: 'Атмосферный фон страницы кейсов TeleBots',
      ctaQuestion: 'Обсудим ваш следующий проект?',
      ctaQuestionShort: 'Бесплатная консультация',
      startDate: { label: 'проектов', value: '200+' },
      duration: { label: 'на рынке', value: '4 года' },
    ...
    services: {
      ...
      pricingChatbots: {
        ...
        plans: [
          { name: 'LITE', price: '100-200', description: 'Идеальный вариант для малого бизнеса, экспертов или кафе. Бот заменяет лендинг или менеджера на первом этапе.', features: ['Приветственное сообщение', 'Ответы на частые вопросы', 'Кнопка «Связаться с менеджером»', 'Сбор заявок в чате'], forWhom: 'Локальный бизнес, инфобизнес (лечебные воронки)' },
      ...
      pricingWebsites: {
        ...
        plans: [
          { name: 'LANDING', price: '150-300', description: 'Одностраничный сайт для презентации продукта или услуги. Быстрый запуск и максимальная конверсия.', features: ['Адаптивный дизайн', 'Форма обратной связи', 'Оптимизация скорости', 'Базовое SEO', 'Интеграция с Google Analytics'], forWhom: 'Стартапы, локальный бизнес, продвижение услуг' },
