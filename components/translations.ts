export const translations = {
  uk: {
    ...
    footer: {
      ...
      termsContent: 'Використовуючи послуги TeleBots, ви погоджуєтеся з нашими умовами використання. Ми забезпечуємо якісні послуги та підтримку наших клієнтів. Всі проєкти реалізуються згідно з домовленостями та в обумовлені терміни.',
  ...
  en: {
    ...
    footer: {
      ...
      termsContent: 'By using TeleBots services, you agree to our terms of service. We provide quality services and support to our clients. All projects are implemented according to agreements and within agreed deadlines.',
  ...
  pl: {
    ...
    footer: {
      ...
      termsContent: 'Korzystając z usług TeleBots, zgadzasz się z naszymi warunkami korzystania. Zapewniamy wysokiej jakości usługi i wsparcie dla naszych klientów. Wszystkie projekty są realizowane zgodnie z ustaleniami i w uzgodnionych terminach.',
  ...
  ru: {
    ...
    footer: {
      ...
      termsContent: 'Используя услуги TeleBots, вы соглашаетесь с нашими условиями использования. Мы обеспечиваем качественные услуги и поддержку наших клиентов. Все проекты реализуются согласно договоренностям и в оговоренные сроки.',
